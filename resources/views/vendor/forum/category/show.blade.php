    ...
    <div class="d-flex flex-row justify-content-between mb-2">
        <h2 style="color: {{ $category->color }};">
            ...
            @if ($category->description)
                <br><small class="text-white">{{ $category->description }}</small>
            @endif
        </h2>
    </div>
    ...
    <div class="v-category-show">
        <div class="clearfix">
            @if ($category->accepts_threads)
                @can ('createThreads', $category)
                    <a href="{{ Forum::route('thread.create', $category) }}" class="btn btn-warning float-end">{{ trans('forum::threads.new_thread') }}</a>
                @endcan
            @endif
        ...
        @if ($category->accepts_threads)
            @if (! $threads->isEmpty())
                        ...
                        <form :action="actions[selectedAction]" method="POST">
                            ...
                            <div class="text-end mt-2">
                                <div class="form-check">
                                    <label for="selectAllThreads" class="text-white">
                ...
                @endif
            @else
                <div class="card my-3 bg-transparent text-white border border-warning rounded">
                    <div class="card-body">
