<div class="category list-group my-4 border border-warning rounded">
    <div class="list-group-item shadow-sm bg-transparent my-1">
    ...
    @if ($category->children->count() > 0)
        <div class="subcategories mx-3 my-3">
            @foreach ($category->children as $subcategory)
                <div class="bg-transparent list-group-item border border-warning my-2">
                    <div class="row align-items-center text-center">
                        <div class="col-sm text-md-start">
                            <a href="{{ Forum::route('category.show', $subcategory) }}" style="color: {{ $subcategory->color }};">{{ $subcategory->title }}</a>
                            <div class="text-white">{{ $subcategory->description }}</div>
                        </div>
                        <div class="col-sm-2 text-md-end ">
