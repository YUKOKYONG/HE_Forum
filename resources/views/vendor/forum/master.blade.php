...
<head>
    ...
    {
        padding: 0;
        background: linear-gradient(black, rgb(44, 44, 44), black, rgb(30, 30, 30));
    ...
    .timestamp
    {
        border-bottom: 1px double var(--bs-gray);
        cursor: help;
    }
...
<body>
    <nav class="v-navbar navbar navbar-expand-md navbar-dark shadow-sm">
        <div class="container">
            @if (Auth::check())
                <a class="navbar-brand" href="{{ url(config('forum.web.router.prefix')) }}"><img src = "{{ asset('images/logo.png') }}" width="80" height="50"></a>
            @else
                <a class="navbar-brand" href="/HE_Forum"><img src = "{{ asset('images/logo.png') }}" width="80" height="50"></a>
            @endif    
            <button class="navbar-toggler icon-org" type="button" :class="{ collapsed: isCollapsed }" @click="isCollapsed = ! isCollapsed">
            <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" :class="{ show: !isCollapsed }">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link text-warning" href="{{ url(config('forum.web.router.prefix')) }}">{{ trans('forum::general.index') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-warning" href="{{ route('forum.recent') }}">{{ trans('forum::threads.recent') }}</a>
                    </li>
                    @auth
                        <li class="nav-item">
                            <a class="nav-link text-warning" href="{{ route('forum.unread') }}">{{ trans('forum::threads.unread_updated') }}</a>
                        </li>
                    @endauth
                    @can ('moveCategories')
                        <li class="nav-item">
